	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-10">
				...
				<?php 
					if(isset($_POST['changeuname'])){
						...
						if(empty($uname)){
							...
							$res = mysqli_query($connect,$query);
							if($res){
								mysqli_query($connect,"SELECT * FROM patients");
				...
				<input type="text-center my-4" name="uname" class="form-control" autocomplete="off" style="width:250px" placeholder="Enter Username"> 
				<br>
